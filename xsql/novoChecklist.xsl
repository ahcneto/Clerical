...
<div data-role="page" id="editar">
	<div data-role="header" data-position="fixed">
		<a href="checklist.xsql?cmd=listChecklist" class="ui-btn-left ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-left ui-icon-back">Voltar</a>
		<h1>Novo Evento</h1>
	...
	<div role="main" class="ui-content">
	 <form action="checklist.xsql" id="formencontros"  method="get">
                    ...
                    <label>Utiliza Campo 1:</label>
                    <select name="flgCustom1">
                        <option value="0">Não</option>
                        <option value="1">Sim</option>
                    </select><br/>

                    <label>Descrição do Campo:</label>
                    <input type="text" name="NmCustom1" value="" /><br/>
	...
	<div data-role="footer" data-position="fixed">
		<h4>Informações do Checklist</h4>
	</div>	
